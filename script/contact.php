...
$reCaptchaSecretKey = '6Le3cvwjAAAAAN1-Ahi4z-KA110rvuth1V3Mg_Dw';

$emailReceiver 		 = "info@themindinterest.com"; 
$defaultEmailSubject = 'The MindInterest Website Contact Form';
/* is You Want To Add Form Subject To Your Default Subject : true/false */
$additionalSubject = true;  
$defaultEmailSender    = "support@themindinterest.com";
...
if (!empty($_POST) && !empty($_POST['email'])) {
		...
		if(mail($emailReceiver, $defaultEmailSubject, $messageString, $emailHeader)){
			...
			$respondArray['message'] = 'Thanks for sending us a message. We will contact to you soon.';
		} else {
			$respondArray['status'] = 0;
